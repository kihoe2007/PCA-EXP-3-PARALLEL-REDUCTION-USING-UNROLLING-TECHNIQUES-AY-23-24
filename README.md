...
<h3>AIM:</h3>
<h3>KISHORE S  M</h3>
<h3>ENTER YOUR REGISTER NO: 212224230131</h3>
<h3>EX. NO : 03</h3>
...
__global__ void reduceUnrolling8 (int *g_idata, int *g_odata, unsigned int n)
{
    ...
    for (int stride = blockDim.x / 2; stride > 0; stride >>= 1)  //right shift operation - divide by 2
    {
        if (tid < stride)
        {
...
## OUTPUT:
<img width="1657" height="87" alt="image" src="https://github.com/user-attachments/assets/8e345b43-5d8f-45b4-8b26-72626c179b5b" />
